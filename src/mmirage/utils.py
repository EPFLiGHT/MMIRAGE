...
if TYPE_CHECKING:
    from mmirage.config import DatasetConfig, InputVar, MMirageConfig, ProcessingParams
...
# helpers
# -------------------------
def load_engine_from_yaml(config_path: str) -> Tuple[sgl.Engine, MMirageConfig]:
    """
    ...
    cfg_obj = from_dict(MMirageConfig, cast(dict, cfg))
